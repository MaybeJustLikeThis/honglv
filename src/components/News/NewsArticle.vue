...
<script setup>
import text from "@/store/News/recommend/zhenneng.js";
...
function resolveImage(paragraph) {
  ...
  if (paragraph.includes("[img:")) {
    ...
    return `<img src="${imgUrl}" alt="Image ${imgUrl}" style="margin: 0 auto; position: relative; display: flex; margin-top: 30px; width: 480px; justify-content: center;">`;
  } else {
