<template>
    ...
    <div class="all">
        ...
        <img
          ...
          class="img-5"
        />
        <div class="div-15">数据中心</div>
        </div>

        <div class="top">
            <div class="left">
                <div class="left-inner"> 
                    <div class="left-top">数据分析</div>
                    <div class="left-bottom"></div>
                </div>
            </div>
            <div class="right">
                <div class="right-inner"> 
                    <div class="right-top">游客分析</div>
        ...
        <div class="bottom">
            <div class="left">
                <div class="left-inner"> 
                    <div class="left-top">我的最热</div>
                    <img src="https://xuejiangbin.oss-cn-beijing.aliyuncs.com/角子崖.png">
                </div>
            </div>
            <div class="right">
                <div class="right-inner"> 
                    <div class="right-top">我的游客</div>
                    <div id="main" ref="mychart" style="width:379px;height:379px;"></div>
                </div>
            </div>
        </div>
...
const option = {
  ...
  series: [
   ...
   const hh = mychart.value
  const myChart = echarts.init(hh);
