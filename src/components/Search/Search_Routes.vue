...
import { getTopRounte,getAllRountes } from "../../utils/api/SearchApi/index"
const valDefault = ref("路线")
...
const imgs = ref([
  {
    url: "../../../public/Search/CarouselImg/Routes/1.jpg",
    desc:"路在脚下，现在就出发"
  },
  {
    url:"../../../public/Search/CarouselImg/Routes/2.jpg",
    desc:"探寻无人之境，充盈自我内心"
  },
  {
    url: "../../../public/Search/CarouselImg/Routes/3.jpg",
    desc:"上春山 下江南•我在黟县醉入一场徽州梦"
  },
  {
    url: "../../../public/Search/CarouselImg/Routes/4.jpg",
    desc:"西藏自驾追冰：冬日限定美景，零距离接触蓝冰冰洞到底有多美"
  }
])

getTopRounte().then(res => {
  // console.log(res.data)
  topRoutes.value = res.data
  // console.log(topRoutes.value,"top") 
})

getAllRountes(currentPage.value,9).then(res => {
