    ...
    <div class="box_bottom">
      ...
      <div class="box_mainbody">
        ...
        <el-pagination layout="prev,pager,next" v-model:current-page="currentPage" :page-count="totalPage"
          :page-size="9" background class="my-pagination" />
      </div>
    </div>
  </div>
</template>
...
const imgs = ref([
  {
    url: "../../../public/Search/CarouselImg/Foods/1.jpg",
    desc:"吃在嘴中，味在心里"
  },
  {
    url:"../../../public/Search/CarouselImg/Foods/2.jpg",
    desc:"食不可挡"
  },
  {
    url: "../../../public/Search/CarouselImg/Foods/3.jpg",
    desc:"“舌尖上的美食”"
  },
  {
    url: "../../../public/Search/CarouselImg/Foods/4.jpg",
