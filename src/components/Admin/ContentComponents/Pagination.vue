<template>
    <el-pagination layout="prev,pager,next" v-model:current-page="currentPage" :page-count="totalPage" :page-size="5" background
...
totalPage.value = Math.ceil(props.scenicsProp.length / 5) 
